  ...
  return (
    <div className="lux-ai-search-page">
      ...
      <div className="lux-ai-container">
        ...
        <section className="lux-ai-cities-section">
          <div className="lux-ai-cities-header">
            ...
            <p className="lux-ai-cities-subtitle">
              Instant AI matchmaking with local sound rider setups, verified talent availability, and direct 0% commission rates.
            </p>
          </div>

          <div className="lux-ai-cities-grid">
            {ALL_CITIES_DIRECTORY.map((city) => (
              <div key={city.name} className="lux-ai-city-card">

    ...
    <form className="lux-modal-form" onSubmit={handleSubmit}>
      ...
      <div className="lux-form-row">
        ...
        <div className="lux-form-group">
          ...
          <input id="modal-phone" name="phone" type="tel" required={formType === 'offer'} placeholder="+91 9XXX-XXXXXX" value={formData.phone} onChange={handleChange} autoComplete="tel" />
        </div>
      </div>
      {formType !== 'offer' && (
        <>
